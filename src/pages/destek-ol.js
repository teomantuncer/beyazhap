...
const DestekOl = ({ location }) => (
	<Layout location={location}>
		...
		<main>
			<div className="mx-auto max-w-7xl py-8 px-3 sm:px-6 lg:px-8 xl:px-0">
				<h2 className="text-2xl font-bold leading-tight text-gray-900">Youtube</h2>
				<p className="px-4 pt-3 pb-6 sm:px-0">
					...
					<div className="py-5 px-4 sm:px-6 lg:py-5 lg:px-8 lg:flex lg:items-center lg:justify-between">
						...
						<div className="mt-8 lex lg:mt-0 lg:flex-shrink-0">
							<div className="inline-flex rounded-md shadow">
								<a href="https://www.youtube.com/channel/UCjsdYhMIQ0-fJPqEjiHYlzA/join" target="_blank" rel="noreferrer" aria-hidden="true" className="inline-flex items-center justify-center px-5 py-2 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
									Destek Ol
								</a>
							</div>
						</div>
				...
				<h2 className="text-2xl mt-12 font-bold leading-tight text-gray-900">SubscribeStar</h2>
				<p className="px-4 pt-3 pb-6 sm:px-0">
				...
				<div className="bg-gray-50">
					<div className="py-5 px-4 sm:px-6 lg:py-5 lg:px-8 lg:flex lg:items-center lg:justify-between">
						...
						<div className="mt-8 lex lg:mt-0 lg:flex-shrink-0">
							<div className="inline-flex rounded-md shadow">
								<a href="https://www.subscribestar.com/efeaydal" target="_blank" rel="noreferrer" aria-hidden="true" className="inline-flex items-center justify-center px-5 py-2 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
									Destek Ol
								</a>
							</div>
						</div>
				...
				<h2 className="text-2xl mt-12 font-bold leading-tight text-gray-900">LBRY</h2>
				<p className="px-4 pt-3 pb-3 sm:px-0">
				...
				<div className="flex pb-6">
					<div className="flex-1 px-4 sm:px-0">
						<ul className="list-disc px-6">
							<li className="pb-2">Önce <a className="text-blue-800 font-bold" href="https://api.lbry.com/user/refer?r=8L6zWt2bLUPmJHtqbiqtL62f36cyjjzp" target="_blank" rel="noreferrer">LBRY.TV</a> sitesine girip üyelik açıyoruz.</li>
					...
					<iframe title="LBRY Üzerinden Destek" className="flex-1 rounded-xl" width="560" height="315" src="https://www.youtube.com/embed/JIuiJm0XYqc" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
				</div>
				<div className="bg-gray-50">
					<div className="py-5 px-4 sm:px-6 lg:py-5 lg:px-8 lg:flex lg:items-center lg:justify-between">
						<h2 className="text-2xl font-bold tracking-tight text-gray-900">
						...
						<div className="mt-8 lex lg:mt-0 lg:flex-shrink-0">
							<div className="inline-flex rounded-md shadow">
								<a href="https://api.lbry.com/user/refer?r=8L6zWt2bLUPmJHtqbiqtL62f36cyjjzp" target="_blank" rel="noreferrer" aria-hidden="true" className="inline-flex items-center justify-center px-5 py-2 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
									Destek Ol
								</a>
							</div>
						</div>
				...
				<h2 className="text-2xl mt-12 font-bold leading-tight text-gray-900">Sanatkardan</h2>
				<p className="px-4 pt-3 pb-6 sm:px-0">
				...
				<div className="bg-gray-50">
					<div className="py-5 px-4 sm:px-6 lg:py-5 lg:px-8 lg:flex lg:items-center lg:justify-between">
						...
						<div className="mt-8 lex lg:mt-0 lg:flex-shrink-0">
							<div className="inline-flex rounded-md shadow">
								<a href="https://sanatkardan.com/sanatkar/aydal-craft-7277" target="_blank" rel="noreferrer" aria-hidden="true" className="inline-flex items-center justify-center px-5 py-2 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
									Destek Ol
								</a>
							</div>
						</div>
